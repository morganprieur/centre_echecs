...
class Get_player_view(): 
    ...
    def formate_data(player_data): 
        ...
        # if ((player_data['genre'] == str('M')) or (player_data['genre'] == 'F') or (player_data['genre'] == 'A')): 
    ...
    def get_many_players():     # dans le controller ? 
        ...
        # else: 
        #     test_or_not = session.prompt( 
        #         f"Lettre non valide : '{test_or_not}'. Les choix possibles sont 'Y' pour 'yes/oui', et 'N' pour 'No/Non' (en majuscules) : \n"
        #     ) 
